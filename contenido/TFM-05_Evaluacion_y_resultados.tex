...
En este apartado se presentan las pruebas realizadas para validar el prototipo de observabilidad. Se describen los objetivos de la evaluación, los métodos empleados para generar tráfico y capturar métricas y trazas, así como los resultados obtenidos a través de Grafana y Jaeger \cite{Ramaswamy2024, Villamizar2021}. La sección se organiza en tres subapartados: pruebas funcionales (5.1), usabilidad y aplicabilidad (5.2) y limitaciones y futuras mejoras (5.3), mostrando evidencia concreta de la instrumentación y la integración del sistema.

Las pruebas realizadas permiten evaluar el cumplimiento de los objetivos definidos en el Capítulo 3, verificando la correcta instrumentación, visualización y trazabilidad de los microservicios, así como la aplicabilidad práctica de la plataforma propuesta.
...
\begin{itemize}
    ...
    \item \textbf{Evaluación limitada del logging:} Aunque se ha integrado un sistema de logging centralizado basado en ELK Stack, su evaluación se ha centrado en la validación funcional y visual, quedando fuera de alcance un análisis exhaustivo de rendimiento, retención y escalabilidad de logs.
