...
\begin{table}[H]
\centering
\caption{Resumen de métricas de CPU y memoria por microservicio. Fuente: Elaboración propia}
\begin{tabular}{lcc}
\toprule
...
\begin{table}[H]
\centering
\caption{Latencia promedio y número de llamadas entre microservicios. Fuente: Elaboración propia}
\begin{tabular}{lcc}
\toprule
