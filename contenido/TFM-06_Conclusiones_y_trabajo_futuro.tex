...
En este capítulo se presentan las principales conclusiones derivadas de los resultados obtenidos y se plantean posibles líneas de trabajo futuro.

\section{Conclusiones}

Este estudio se ocupó del desafío de establecer una plataforma de observabilidad para sistemas que emplean microservicios, centrándose en cómo reunir y representar métricas, trazas y registros mediante tecnologías de código abierto como OpenTelemetry, Prometheus y Grafana. Para probar la solución, configuramos un entorno de monitoreo usando Kubernetes (Minikube), lo que nos permitió integrar y evaluar los elementos esenciales para el monitoreo y análisis del sistema.
...
\begin{itemize}
	...
	\item \textbf{Resiliencia y pruebas de carga:} Evaluar cómo la plataforma de observabilidad responde bajo diferentes cargas y condiciones adversas. Esto permitiría ajustar los límites de alertas, mejorar el escalado automático y garantizar la estabilidad de los microservicios.
