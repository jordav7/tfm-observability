...
\begin{itemize}
	...
	\item Implementar la automatización del despliegue utilizando Docker y Kubernetes, inicialmente sobre un entorno local (Minikube), con la posibilidad de ampliar la infraestructura mediante Terraform en futuras fases.
...
\begin{enumerate}
	...
	\item \textbf{Posible extensión}: Aunque la infraestructura se desplegará en un entorno local para esta fase, se dejará preparada la posibilidad de usar Terraform para definir y desplegar infraestructura en entornos cloud en trabajos futuros.
\end{enumerate}
