...
\begin{itemize}
	...
	\item Separación de capas de construcción y ejecución para reducir tiempos de despliegue y mejorar la cacheabilidad de las imágenes.
...
\begin{itemize}
	\item Generación de tráfico simulado mediante herramientas como JMeter o locust.io para evaluar métricas de rendimiento y latencia.
...
\begin{itemize}
	...
	\item \textbf{Reducción de errores humanos}: minimiza tareas manuales y repetitivas.
