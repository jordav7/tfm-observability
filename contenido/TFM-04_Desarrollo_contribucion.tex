...
Este capítulo describe el desarrollo detallado del prototipo de plataforma de observabilidad para microservicios. Se incluyen la planificación, el análisis de requisitos, la justificación de las tecnologías empleadas, la arquitectura del sistema, la implementación técnica, la instrumentación de los microservicios y la evaluación mediante pruebas funcionales y de usabilidad. 

El capítulo se organiza de la siguiente manera: en el apartado 4.1 se presentan la planificación, el análisis de requisitos y la selección de tecnologías; en 4.2 se detalla la arquitectura del sistema, la implementación de los microservicios y la integración de herramientas de observabilidad; finalmente, en 4.3 se describen las pruebas realizadas, la evaluación de la usabilidad y aplicabilidad del prototipo, y las posibles limitaciones y mejoras futuras.

\section{Planificación, Análisis y Requisitos}

En este apartado se describe el contexto y problema que motivaron el proyecto, la elección de tecnologías, la organización del desarrollo y los requisitos funcionales y no funcionales que guían la construcción del prototipo. Este apartado se divide en los subapartados: 
\begin{itemize}
	\item 4.1.1 Contexto y problema.
	\item 4.1.2 Justificación de tecnologías.
	\item 4.1.3 Organización del desarrollo.
	\item 4.1.4 Requisitos funcionales y no funcionales.
\end{itemize}
...
Adicionalmente, la falta de estandarización en la instrumentación de microservicios y la diversidad de frameworks y lenguajes usados en un entorno de producción real generan desafíos concretos:
...
En este contexto, el prototipo diseñado busca ofrecer una solución replicable y controlada que permita:

\begin{itemize}
    \item Visualizar el comportamiento de las aplicaciones y detectar fallos de manera temprana.
    \item Analizar tiempos de respuesta, latencias y carga entre servicios.
    \item Correlacionar trazas de solicitudes para comprender el flujo completo entre microservicios.
    \item Servir como base de aprendizaje y experimentación sin requerir un entorno productivo completo.
\end{itemize}

Este enfoque proporciona una justificación técnica clara para la elección de OpenTelemetry, Prometheus, Grafana y Jaeger, ya que estas herramientas permiten instrumentar los servicios de manera uniforme, recolectar métricas y trazas, y visualizarlas de forma centralizada sin modificar el código fuente.
...
\begin{itemize}
	...
	\item 4.2.3 Metodología de desarrollo: enfoque iterativo, control de versiones y documentación progresiva.
\end{itemize}
...
En este apartado se presentan las pruebas realizadas para validar el prototipo de observabilidad. Se describen los objetivos de la evaluación, los métodos empleados para generar tráfico y capturar métricas y trazas, así como los resultados obtenidos a través de Grafana y Jaeger. La sección se organiza en tres subapartados: pruebas funcionales (4.3.1), usabilidad y aplicabilidad (4.3.2) y limitaciones y futuras mejoras (4.3.3), mostrando evidencia concreta de la instrumentación y la integración del sistema.
...
\subsection{Pruebas de usabilidad y aplicabilidad}
...
\begin{itemize}
    ...
    \item \textbf{Replicabilidad:} La documentación y scripts incluidos facilitan la replicación del entorno por parte de otros desarrolladores, permitiendo pruebas y experimentación sin riesgo sobre entornos productivos.
...
Como resultado, se confirma que el prototipo no solo cumple con los requisitos funcionales, sino que también puede servir como entorno educativo o de prueba para equipos de desarrollo que desean experimentar con observabilidad distribuida sin complejidad excesiva.
...
\begin{itemize}
    ...
    \item \textbf{Escalabilidad restringida:} La prueba se realizó con un número reducido de microservicios y tráfico simulado; escenarios con mayor concurrencia podrían requerir ajustes.
...
Estas limitaciones ofrecen oportunidades para la expansión del prototipo, incluyendo:

\begin{itemize}
    \item Integración de un sistema de alertas.
    \item Adición de más microservicios y pruebas de escalabilidad.
    \item Extensión de dashboards y métricas personalizadas.
    \item Instrumentación de logs centralizados.
\end{itemize}
