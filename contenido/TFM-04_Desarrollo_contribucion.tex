...
\begin{figure}[H]
    ...
    \caption{Arquitectura de logging centralizado con ELK y Filebeat. Fuente: Elaboración propia.}
...
\begin{table}[H]
\centering
\caption{Resumen de logs recolectados por microservicio durante la prueba. Fuente: Elaboración propia}
\begin{tabular}{lcc}
\toprule
...
\begin{figure}[H]
	...
	\caption{Arquitectura de despliegue y automatización del prototipo de observabilidad usando GitHub Actions, Docker, Ansible, Helm y Minikube. Fuente: Elaboración propia.}
